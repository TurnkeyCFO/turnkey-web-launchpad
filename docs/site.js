...
function updatePreview() {
  const payload = {
    ...
    budgetBand: document.getElementById("budgetBand")?.value,
    pageCountBand: document.getElementById("pageCountBand")?.value,
    goals: collectMultiSelect("goals"),
    features: collectMultiSelect("features")
  };
  ...
  setText("preview-timeline", payload.timeline);
  setText("preview-pages", payload.pageCountBand);
...
document.getElementById("estimate-form")?.addEventListener("input", updatePreview);
document.getElementById("estimate-form")?.addEventListener("change", updatePreview);
